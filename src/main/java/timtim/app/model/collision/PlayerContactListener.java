...
public class PlayerContactListener implements ContactListener {
	...
	void handlePowerUpContact(Fixture fa, Fixture fb) {
	...
	void handleDoorContact(Fixture fa, Fixture fb) {
	...
	void handleChestContact(Fixture fa, Fixture fb) {
	...
	void handleFriendContact(Fixture fa, Fixture fb) {
	...
	void handleFloraContact(Fixture fa, Fixture fb) {
	...
	void handleDeathzoneContact(Fixture fa, Fixture fb) {
	...
	void handleEnemyContact(Fixture fa, Fixture fb) {
