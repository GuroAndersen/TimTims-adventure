...
public class MyContactListener implements ContactListener {
    ...
    public MyContactListener(GameScreen game, GameMap gameMap) {
        this.game = game;
        this.gameMap = gameMap;
    }

    // Handles contact between player and door.
    private void handlePlayerDoorContact(Fixture fa, Fixture fb) {
    ...
    private void handlePlayerChestContact(Fixture fa, Fixture fb) {
    ...
    private void handlePlayerFriendContact(Fixture fa, Fixture fb) {
    ...
    private void handlePlayerFloraContact(Fixture fa, Fixture fb) {
    ...
    private void handlePlayerDeathzoneContact(Fixture fa, Fixture fb) {
    ...
    public void beginContact(Contact contact) {
        ...
        handlePlayerDoorContact(fa, fb);

        handlePlayerChestContact(fa, fb);

        handlePlayerFriendContact(fa, fb);

        handlePlayerFloraContact(fa, fb);

        handlePlayerDeathzoneContact(fa, fb);
    }
